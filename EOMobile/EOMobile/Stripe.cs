...
namespace EOMobile
{
    ...
    {
        Task<string> CardToToken(CreditCard creditCard);
    ...
    public class StripeServices : IStripeServices
    {
        ...
        public async Task<string> CardToToken(CreditCard creditCard)
        {
            string checkToken = String.Empty;
    ...
    public class CreditCard
    {
        ...
        public List<string> VerifyCreditCardInfo()
        {
            ...
            try
            {
                ...
                if (month < 1 || month > 12)
                {
                    messages.Add("the expiration month date must be >= 1 and <= 12");
                }
